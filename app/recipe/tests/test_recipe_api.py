...
class PublicRecipeTestApiTest(TestCase):
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_limited_to_user(self):
        """Test retriving recipe list for current user only"""
    ...
    def test_filter_recipe_by_ingredients(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Chicken caccioatore')
...
class RecipeImageUpload(TestCase):
    ...
    def tearDown(self):
        """Runs after completing the test"""
    ...
    def test_upload_image_to_recipe(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as ntf:
            img = Image.new('RGB', (10, 10))  # creates an image
